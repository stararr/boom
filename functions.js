...
" thinks that there is no perfect star... And no perfect Star, either.",
...
var stars = ["./images/star.png", "./images/star_happy.png", "./images/star_contented.png", "./images/star_sleepy.png"]
var loaded, currentsoundtobeloaded;
var squeaks = Array();
...
function onReady(callback) {
    var intervalId = window.setInterval(function() {
        if ((document.body !== undefined) && (loaded=7)) {
...
function resetReaction() {
    ...
    for (incr of [0,1]) {
        ...
        secondpart = ((3-reaction[incr])>0) ? '<div></div>'.repeat(3-reaction[incr]) : "";
...
function createDataString() {
    for (circle of document.getElementsByClassName('datacircle')) {circle.style.backgroundColor='slategrey';}
    currentdataindex = 0;
    currentdata=document.getElementsByClassName('datacircle')[currentdataindex];
    currentdata.style.borderColor='skyblue';
...
function nextData(button) {
    currentdata.style.borderColor = 'black';
...
function resetSwitches() {
    ...
    for (switchylighty of document.getElementsByClassName('switchlight')) {switchylighty.style.backgroundColor = 'red';}
    inputswitch=[0,0,0,0];
    switchstring="";
    inputstring="";
...
function switchSwitch(switchy) {
    switch (switchy.toggle) {
        case 'off':
            ...
            switchy.toggle='on';
            document.getElementsByClassName('switchlight')[switchy.switchnumber].style.backgroundColor = 'limegreen';
            break;
        case 'on':
            switchy.style.backgroundImage="linear-gradient(grey 0%, whitesmoke 50%, whitesmoke 100%)"
            inputswitch[switchy.switchnumber]=0;
            switchy.toggle='off';
            document.getElementsByClassName('switchlight')[switchy.switchnumber].style.backgroundColor = 'red';
            break;
